...
function PageTrashList() {
  ...
  const [reLoad, setReLoad] = useState();
    ...
    useEffect(function(){
      (async function(){
        setLoad(true)
        const result = await PageServices.trash(page);
    ...
    async function handleReStore(id) {
      const result = await PageServices.restore(id)
      // alert(result.message)
      setReLoad(Date.now)
    }
      //------------pagination-------------
                        ...
                        <tr className="datarow" key={index}>
                          ...
                          <td>
                            <div className='row'>
                              ...
                              <button onClick={()=>handleReStore(page.id)} className="btn btn-success btn-sm">
                                  <TbRestore />
                                </button>
